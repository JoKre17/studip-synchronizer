...
public class SimpleWindowController implements Initializable {
	...
	public void createTrayIcon(final Stage stage) {
		if (SystemTray.isSupported()) {
			...
			trayIcon = new TrayIcon(SwingFXUtils.fromFXImage(SynchronizerApp.ICON_TRANSPARENT, null), "StudIP Synchronizer", popup);
	...
	public void showProgramIsMinimizedMsg() {
		if (firstTimeMinimizedToTray) {
			trayIcon.displayMessage("StudIP Synchronizer", "Still running in background.", TrayIcon.MessageType.INFO);
